      ...
      <div className="p-4 border-t border-[#dce8b9]/50 bg-[#FDFDFD]">
        <div className="flex items-center space-x-2">
          <input
            ...
            className="flex-grow p-2 border border-gray-300 bg-white rounded-md text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-[#80a040] focus:border-[#80a040]"
            disabled={isLoading}
          />
